// components/common/FloatingChat.jsx
  ...
  return (
    <div className="fixed bottom-6 right-6 z-50 flex flex-col items-end">
      ...
      <AnimatePresence mode="wait">
        {isOpen && (
          <motion.div
            className="bg-white rounded-2xl shadow-xl mb-4 w-80 sm:w-96 overflow-hidden"
          ...
          >
                    ...
                    <div
                      className={`rounded-2xl px-4 py-2 inline-block ${
                        msg.sender === "bot"
                          ...
                          : "bg-gray-200 text-dark rounded-br-none"
                      }`}
                    >
                      {msg.text}
                    </div>
            ...
            <div className="p-3 border-t">
              <form onSubmit={handleSubmit} className="flex items-center">
                <input
                  type="text"
                  className="flex-1 bg-gray-100 rounded-full px-4 py-2 focus:outline-none focus:ring-2 focus:ring-primary"
      ...
      <AnimatePresence mode="wait">
        {showBubble && !isOpen && (
          <motion.div
            className="bg-white rounded-xl shadow-lg p-3 mb-3 max-w-xs"
          ...
          >
            <div className="flex items-start">
              ...
              <div>
                ...
                <p className="text-xs text-gray-500 mt-1">Chat with us now!</p>
              </div>
              <button
